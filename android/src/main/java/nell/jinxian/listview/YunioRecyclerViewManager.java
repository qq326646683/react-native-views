 ...
 */
public class YunioRecyclerViewManager extends
        ViewGroupManager<RecyclerViewBackedScrollView> {

    public static final String REACT_CLASS = "AndroidRecyclerViewScrollView";
    ...
    private static final String TAG = "YunioRecyclerViewManager";
