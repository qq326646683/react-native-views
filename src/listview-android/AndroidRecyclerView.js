...
import ReactNative, {
  View, requireNativeComponent, DeviceEventEmitter, StyleSheet, UIManager, ViewPropTypes,
  ToastAndroid
} from 'react-native';
...
const NativeRecyclerViewItem = requireNativeComponent('RTCRecyclerViewItemView');
...
const NativeRecyclerView = requireNativeComponent('AndroidRecyclerViewScrollView', RecyclerView, nativeOnlyProps);
